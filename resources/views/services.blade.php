    ...
    <section id="content" class="bg-white shadow-md rounded-lg p-6 shadow-md">
        ...
        <ul class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <li class="bg-gray-100 text-blue-900 rounded-lg p-6 shadow-md">
                ...
                <a href="https://mcrplasticsurgeryandburns.co.uk//our-services/abdominal-chest-wall-reconstruction/" class="inline-block px-6 py-3 bg-blue-900 text-white font-bold rounded-lg hover:bg-blue-600 transition duration-300">Learn More</a>
            </li>
            @endforeach
        </ul>
    </section>
